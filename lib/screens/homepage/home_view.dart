...
class HomeView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final double padding = (maxWidth > 1200) ? (maxWidth - 1200) / 2 : 10;
    ...
    return Material(
      ...
      child: ResponsiveLayout(
        desktopView: Container(
          constraints:
              BoxConstraints(maxWidth: maxWidth < 1200 ? maxWidth : 1200),
          ...
          child: Row(
            ...
            children: [
              Expanded(
                  flex: 23, child: SideBar(homeController: homeController)),
              const SizedBox(
                width: 16,
              ),
              Expanded(
                  flex: 77, child: MainPage(homeController: homeController))
            ],
          ),
        ),
    ...
    return [
      ...
      TabItem(
        ...
        onTap: () {
          ...
          homeController.selectedTabName.value = "Certificates";
        },
      ...
      TabItem(
        title: "Contact",
        onTap: () {
          homeController.selectedTabIndex.value = 4;
          homeController.selectedTabName.value = "Contact";
        },
        isSelected: homeController.selectedTabIndex.value == 4,
        padding: const EdgeInsets.symmetric(horizontal: 10),
      ),
    ];
  }
                      ...
                      children: [
                        Padding(
                          padding: const EdgeInsets.only(
                              left: 10, top: 16, bottom: 0),
                          child: SelectableText(
                            homeController.selectedTabName.value,
                    ...
                    CustomListTile(
                        ...
                        onTap: () {
                          launchUrl(
                              Uri(
                                  scheme: "mailto",
                                  path: CommonStrings.myDetails['email']),
                              mode: LaunchMode.platformDefault);
                        }),
                    CustomListTile(
                        icon: Icons.phone_android,
                        ...
                        onTap: () {
                          launchUrl(
                              Uri(
                                  scheme: "tel",
                                  path: CommonStrings.myDetails['mobile']),
                              mode: LaunchMode.platformDefault);
                        }),
                    CustomListTile(
                      icon: Icons.location_on_outlined,
...
class CustomListTile extends StatelessWidget {
  ...
  IconData? icon;
  void Function()? onTap;
  CustomListTile({this.title, this.subtitle, this.icon, this.onTap, super.key});
